...
@endif
        <form method="POST" action="{{route('kelulusan-post')}}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="orang_tua" value="{{old('orang_tua')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="tahun_lulus" value="{{old('tahun_lulus')}}">
